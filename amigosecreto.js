...
function showAlreadyDrawn() {
  ...
  document.querySelector('.container').innerHTML = `
    ...
    <p>Seu amigo secreto é <strong>${data.name}</strong>. Se perdeu o print, aqui tá de novo:</p>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('send-whatsapp').addEventListener('click', () => {
    const message = encodeURIComponent(`Oi Luiza! Tirei ${drawnPerson.name} no amigo secreto 2025 da família Pereira. Aqui está o print! 🎄`);
