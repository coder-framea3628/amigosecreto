...
.bottom-sheet {
  ...
  padding: 40px 28px 50px; /* padding-bottom um pouco menor */
  transform: translateY(100%);
  transition: transform 0.5s ease;
  z-index: 10000;
  max-height: 82vh; /* diminui um pouquinho a altura máxima */
  overflow-y: auto;
...
document.body.innerHTML = `
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step2" class="step">
      ...
      <div class="profile-grid">
        ...
        <div class="profile-card" data-name="Luiza">
          <img class="profile-img" src="https://framerusercontent.com/images/jjvgBrGxMkjCcf37wNfwlrxIdKw.jpeg" alt="Luiza">
          <div class="profile-name">Luiza</div>
    ...
    <div id="step3" class="step">
      <h2>Está pronto para o sorteio?</h2>
      <p>Respira fundo, toca no botão e descubra quem é seu amigo secreto esse ano! 🎁</p>
      <button class="btn" id="spin-btn">Girar agora</button>
    </div>
    <div class="footer">
  ...
  <div class="bottom-sheet" id="result-popup">
    ...
    <p style="font-size:1.1rem; margin:20px 0;">Agora é hora de caprichar no presente, hein?</p>
    <p style="font-size:1rem;">Tire um print dessa tela e clique no botão abaixo:</p>
  ...
  <div class="bottom-sheet" id="code-popup">
    ...
    <p>Para garantir que tudo fique certinho e ninguém repita, envie o print de quem você tirou pra mim (Luiza) pelo WhatsApp.</p>
    <button class="btn" id="send-whatsapp">Enviar agora pelo WhatsApp</button>
  </div>
...
const profiles = [
  ...
  { name: "Luiza", img: "https://framerusercontent.com/images/jjvgBrGxMkjCcf37wNfwlrxIdKw.jpeg" },
...
// Removido Matheus do sorteio (spinner)
const spinnerProfiles = [
  { name: "Ayrton", img: "https://framerusercontent.com/images/mo6h6LH2URKoUDkdQCvKL1YV4.jpeg" },
  { name: "Luiza", img: "https://framerusercontent.com/images/jjvgBrGxMkjCcf37wNfwlrxIdKw.jpeg" },
  { name: "Leide", img: "https://framerusercontent.com/images/pcXzS5xFHN3vBFce2yh7ZlfJ0IM.jpeg" }
];
...
function showAlreadyDrawn() {
  ...
  document.querySelector('.container').innerHTML = `
    <h1>Ei, você já sorteou!</h1>
    <p>Seu amigo secreto esse ano é <strong>${data.name}</strong>. Se perdeu o print, aqui tá de novo:</p>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('confirm-yes').addEventListener('click', () => {
    ...
    showLoading();
    // Usa a lista fixa sem Matheus para o sorteio
    spinnerParticipants = spinnerProfiles.filter(p => p.name !== selectedProfile.name);
    setTimeout(() => {
      hideLoading();
      showStep(3);
    }, 1800);
  ...
  document.getElementById('send-whatsapp').addEventListener('click', () => {
    const message = encodeURIComponent(`Oi Luiza! Tirei ${drawnPerson.name} no amigo secreto 2025 da nossa família. Aqui está o print :) `);
  ...
  document.getElementById('overlay-black').addEventListener('click', () => {
    if (document.getElementById('result-popup').classList.contains('show')) return;
