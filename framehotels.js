// ============================================================================
// FRAME HOTELS — HUB DE HOTELARIA v2.0 (Mobile First & Responsivo)
...
// ===== HOTEL DATA (Importados do Scheduling para Imagens Reais) =====
const FH_HOTELS = [
  {
    id: 1, name: 'Rosewood São Paulo', city: 'São Paulo', neighborhood: 'Bela Vista',
    rating: 5.0, reviews: 3412, priceFrom: 3200,
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/1b/47/10/premier-two-queens.jpg',
    images: [
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/1b/47/10/premier-two-queens.jpg',
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/1b/46/fd/matarazzo-suite-room.jpg'
    ],
    tags: ['SPA', 'Piscina Infinita', 'Gastronomia', 'Design'], verified: true, hotelsPlus: true,
    desc: 'Eleito o melhor hotel da América do Sul. Localizado na histórica Cidade Matarazzo em Bela Vista, oasis urbano com Torre Mata Atlântica projetada por Jean Nouvel, piscina infinita no rooftop e seis opções gastronômicas premiadas.'
  },
  {
    id: 2, name: 'Hotel Fasano São Paulo', city: 'São Paulo', neighborhood: 'Jardins',
    rating: 4.9, reviews: 2876, priceFrom: 2450,
    image: 'https://www.fasano.com.br/wp-content/uploads/2023/06/4.Suite-Deluxe.jpg',
    images: [
      'https://www.fasano.com.br/wp-content/uploads/2023/06/4.Suite-Deluxe.jpg',
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/71/6a/bd/hotel-fasano-sao-paulo.jpg'
    ],
    tags: ['Restaurante Gero', 'Piscina', 'Academia'], verified: true, hotelsPlus: true,
    desc: 'Projeto assinado por Isay Weinfeld e Márcio Kogan, com restaurante renomado, hospitalidade familiar e serviço de alto padrão, símbolo de elegância e tradição na capital paulista.'
  },
  {
    id: 3, name: 'Copacabana Palace', city: 'Rio de Janeiro', neighborhood: 'Copacabana',
    rating: 4.9, reviews: 5102, priceFrom: 2800,
    image: 'https://img.belmond.com/photos/cop/cop-acc-suite-penthouse-ocean-view06.jpg',
    images: [
      'https://img.belmond.com/photos/cop/cop-acc-suite-penthouse-ocean-view06.jpg',
      'https://img.belmond.com/photos/cop/cop-ext05.jpg'
    ],
    tags: ['Icônico', 'Beira-mar', 'Piscina'], verified: true, hotelsPlus: true,
    desc: 'Hotel cinco estrelas tradicional em Copacabana, reconhecido mundialmente pelo serviço de excelência e vista deslumbrante para o mar. Um ícone da hospitalidade brasileira.'
  },
  {
    id: 4, name: 'Emiliano Rio', city: 'Rio de Janeiro', neighborhood: 'Ipanema',
    rating: 4.8, reviews: 1523, priceFrom: 2200,
    image: 'https://emiliano.com.br/wp-content/uploads/2016/10/emiliano.com.br-oceanjuniorsuite-rio-scaled.jpeg',
    images: [
      'https://emiliano.com.br/wp-content/uploads/2016/10/emiliano.com.br-oceanjuniorsuite-rio-scaled.jpeg',
      'https://emiliano.com.br/wp-content/uploads/2016/10/emiliano.com.br-004-fernandoguerra-1.jpg'
    ],
    tags: ['Beira-mar', 'Bar / Lounge', 'SPA'], verified: true, hotelsPlus: false,
    desc: 'Hotel boutique à beira-mar, com ambiente intimista, serviço personalizado e localização privilegiada em Ipanema, oferecendo o melhor que o Rio tem a oferecer.'
  },
  {
    id: 5, name: 'Nomaa Hotel', city: 'Curitiba', neighborhood: 'Batel',
    rating: 4.8, reviews: 1287, priceFrom: 850,
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/20/36/63/nomaa-hotel.jpg',
    images: [
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/20/36/63/nomaa-hotel.jpg',
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/30/03/d9/cb/caption.jpg'
    ],
    tags: ['Design', 'Gastronomia', 'SPA'], verified: true, hotelsPlus: true,
    desc: 'Localizado no bairro Batel, voltado ao design, arte e hospedagem de alto nível. Ideal para quem procura elegância contemporânea e atmosfera criativa.'
  },
  {
    id: 6, name: 'Radisson Hotel Curitiba Batel', city: 'Curitiba', neighborhood: 'Batel',
    rating: 4.6, reviews: 1545, priceFrom: 520,
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/19/ca/05/d6/business-class.jpg',
    images: [
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/19/ca/05/d6/business-class.jpg',
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/05/7b/9f/22/radisson-hotel-curitiba.jpg'
    ],
    tags: ['Business', 'Piscina', 'Fitness'], verified: true, hotelsPlus: false,
    desc: 'Situado no bairro Batel, combina padrão internacional, localização central e estrutura completa — uma das referências de hospedagem em Curitiba.'
  },
  {
    id: 7, name: 'Hilton Porto Alegre', city: 'Porto Alegre', neighborhood: 'Moinhos de Vento',
    rating: 4.7, reviews: 1678, priceFrom: 750,
    image: 'https://www.hilton.com/im/en/POAOBHH/16481189/she-pbxsi-exec-guaiba-02.jpg',
    images: [
      'https://www.hilton.com/im/en/POAOBHH/16481189/she-pbxsi-exec-guaiba-02.jpg',
      'https://www.hilton.com/im/en/POAOBHH/19162817/-dnd6666.jpg'
    ],
    tags: ['Piscina Coberta', 'Fitness', 'Restaurante'], verified: true, hotelsPlus: true,
    desc: 'Hotel internacional de luxo com quartos premium, localização central e estrutura completa para lazer e negócios de alto nível na capital gaúcha.'
  },
  {
    id: 8, name: 'Hotel Fasano Belo Horizonte', city: 'Belo Horizonte', neighborhood: 'Lourdes',
    rating: 4.9, reviews: 1492, priceFrom: 1880,
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/71/3c/41/hotel-fasano-belo-horizonte.jpg',
    images: [
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/71/3c/41/hotel-fasano-belo-horizonte.jpg',
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/71/3b/b4/hotel-fasano-belo-horizonte.jpg'
    ],
    tags: ['Charme', 'Gastronomia', 'Piscina'], verified: true, hotelsPlus: true,
    desc: 'Localizado no bairro Lourdes, um dos mais nobres de BH, com gastronomia de alto nível, spa e piscina na cobertura.'
  }
];

const FH_CITIES = [
  { name: 'São Paulo', state: 'SP', count: 4, image: 'https://images.unsplash.com/photo-1543059080-f9b1272213d5?w=600&q=80' },
  { name: 'Rio de Janeiro', state: 'RJ', count: 3, image: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=600&q=80' },
  { name: 'Curitiba', state: 'PR', count: 3, image: 'https://images.unsplash.com/photo-1598977123118-4e30ba3c4f5b?w=600&q=80' },
...
:root {
  ...
  --fh-accent: #AC865C;
  --fh-accent-dark: #B38654;
  --fh-accent-gradient: linear-gradient(135deg, #AC865C 0%, #D29F66 100%);
  --fh-accent-light: #F4E8DB;
  --fh-border: #E5E5E5;
...
.fh-search-card {
  ...
  max-width: 390px; margin: 0 auto; /* LIMITA NO MOBILE */
}
...
/* === SECTION HEADERS === */
.fh-section { padding: 24px 16px 0; max-width: 1200px; margin: 0 auto; }
.fh-section-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px; max-width: 390px; margin-left: auto; margin-right: auto; }
.fh-section-title { font-family: var(--fh-font-display); font-size: 20px; font-weight: 700; color: var(--fh-text); }
.fh-section-link {
...
.fh-hotels-grid {
  display: grid; 
  grid-template-columns: 1fr; /* Responsivo inicial */
  gap: 24px;
}
...
.fh-hotel-card {
  ...
  transition: var(--fh-transition);
  max-width: 390px; /* LIMITA TAMANHO NO MOBILE */
  margin: 0 auto;
  width: 100%;
...
.fh-hotel-info { padding: 16px 18px 20px; }
.fh-hotel-top { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 6px; }
.fh-hotel-name { font-family: var(--fh-font-display); font-size: 17px; font-weight: 700; color: var(--fh-text); line-height: 1.2; padding-right: 10px; }
.fh-hotel-rating { display: flex; align-items: center; gap: 4px; font-size: 14px; font-weight: 600; color: var(--fh-text); flex-shrink: 0; }
.fh-hotel-rating svg { color: var(--fh-accent); }
.fh-hotel-location { font-size: 13px; color: var(--fh-text-secondary); margin-bottom: 8px; display: flex; align-items: center; gap: 4px; }
.fh-hotel-tags { display: flex; gap: 6px; flex-wrap: wrap; margin-bottom: 12px; }
.fh-hotel-tag {
  font-size: 11px; padding: 5px 12px; border-radius: var(--fh-radius-pill);
  background: var(--fh-bg); color: var(--fh-text-secondary); font-weight: 500;
}
.fh-hotel-price { display: flex; align-items: baseline; gap: 4px; margin-top: auto; }
.fh-hotel-price-label { font-size: 12px; color: var(--fh-text-secondary); }
.fh-hotel-price-value { font-size: 18px; font-weight: 800; color: var(--fh-text); }
.fh-hotel-price-unit { font-size: 13px; color: var(--fh-text-secondary); }

/* === HOTELS+ BANNER === */
.fh-plus-banner {
  margin: 28px auto; max-width: 390px;
...
.fh-sheet {
  ...
  max-width: 600px; margin: 0 auto; /* LIMITA SHEET NO DESKTOP */
}
...
/* === HOTEL DETAIL VIEW === */
.fh-detail { display: none; background: var(--fh-white); min-height: 100vh; }
.fh-detail.show { display: block; }
.fh-detail-hero { position: relative; width: 100%; height: 350px; overflow: hidden; }
...
.fh-detail-body { padding: 24px 20px; max-width: 600px; margin: 0 auto; }
.fh-detail-title { font-family: var(--fh-font-display); font-size: 26px; font-weight: 700; margin-bottom: 6px; line-height: 1.2; }
.fh-detail-subtitle { font-size: 14px; color: var(--fh-text-secondary); margin-bottom: 16px; display: flex; align-items: center; gap: 6px; flex-wrap: wrap; }
.fh-detail-rating {
...
.fh-detail-amenity {
  ...
  color: var(--fh-text-secondary); border: 1px solid var(--fh-border-light);
}
...
@media(min-width:768px) { .fh-detail-cta { justify-content: center; gap: 40px; } }
...
/* === LOCATION BANNER === */
.fh-location-banner {
  margin: 0 auto 0; max-width: 390px;
...
@media(min-width:640px) { .fh-location-banner { max-width: none; margin-left: 20px; margin-right: 20px;} }
...
@media(min-width:640px) {
  .fh-hotels-grid { grid-template-columns: 1fr 1fr; justify-content: start; }
  .fh-hotel-card { max-width: none; }
  .fh-search-card { max-width: none; }
  .fh-section-header { max-width: none; }
  .fh-cities-scroll { max-width: none; }
  .fh-exp-scroll { max-width: none; }
  .fh-plus-banner { max-width: none; margin: 36px 0; }
  .fh-filter-tags { max-width: none; justify-content: flex-start; }
}
@media(min-width:768px) {
  ...
  .fh-detail-cta { bottom: 0; border-top: none; box-shadow: 0 -4px 30px rgba(0,0,0,0.05); }
}
@media(min-width:960px) { 
  .fh-hotels-grid { grid-template-columns: 1fr 1fr 1fr; } 
}
...
.fh-filter-tags {
  ...
  scrollbar-width: none; max-width: 390px; margin: 0 auto;
}
  ...
  <div class="fh-search-bar">
    <div class="fh-search-card fh-animate" onclick="fhOpenSearch()">
      ...
      <div class="fh-search-text">
        ...
        <p>Qualquer lugar · Qualquer semana</p>
      </div>
...
function fhBuildFilterTags() {
  const tags = ['Todos', 'Hotels+', 'Piscina', 'SPA', 'Gastronomia', 'Beira-mar', 'Design', 'Business'];
  return `
      ...
      ${FH_CITIES.map(c => `
        <div class="fh-city-card" onclick="fhSelectCity('${c.name}')">
          ...
          <div class="fh-city-card-overlay">
            <h4>${c.name}</h4>
            <span>${c.count} hoteis parceiros</span>
          </div>
        </div>
      `).join('')}
    </div>
...
function fhBuildHotelsPlusSection() {
  return `
  <div class="fh-section fh-animate fh-animate-d2" style="padding-top:0;">
    <div class="fh-plus-banner" onclick="fhFilterTag(document.querySelector('.fh-filter-tag:nth-child(2)'),'Hotels+')">
...
function fhBuildExperiencesSection() {
  const exps = [
    { title: 'Spa & Bem-estar', desc: 'Relaxe com os melhores spas', img: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&q=80' },
    { title: 'Gastronomia', desc: 'Restaurantes premiados', img: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80' },
    { title: 'Vista panoramica', desc: 'Suites com as melhores vistas', img: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=600&q=80' },
  ];
  return `
  <div class="fh-section fh-animate fh-animate-d4" style="margin-bottom: 24px;">
    <div class="fh-section-header">
...
function fhBuildMenuOverlay() {
  ...
  <div id="fhMenu" class="fh-menu">
    ...
    <div class="fh-menu-items">
      ...
      <div class="fh-menu-item" onclick="window.open('https://frameag.com','_blank')">${FH_ICONS.globe} frameag.com</div>
    </div>
    <div class="fh-menu-footer">
      Frame Hotels by Frame Agency<br/>Todos os direitos reservados.
    </div>
  </div>`;
}
  ...
  <footer class="fh-footer">
    <div class="fh-footer-inner">
      ...
      <div class="fh-footer-bottom">
        <span class="fh-footer-copy">2025 Frame Hotels by Frame Agency. Todos os direitos reservados.</span>
...
function fhOpenHotel(id) {
  ...
  detail.innerHTML = `
    ...
    <div class="fh-detail-body">
      ...
      <div class="fh-detail-subtitle">
        ...
        ${hotel.hotelsPlus ? `<span style="background:var(--fh-accent-gradient);color:white;padding:3px 12px;border-radius:20px;font-size:11px;font-weight:700;display:inline-flex;align-items:center;gap:4px;margin-left:6px;">${FH_ICONS.crown} Hotels+</span>` : ''}
      </div>
  ...
  if (!cta) {
    ...
    `;
    document.getElementById('fhDetailView').appendChild(ctaEl);
  } else {
